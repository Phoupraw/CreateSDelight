...
open class ServerItemQueueGuiDescription(syncId: Int, playerInventory: PlayerInventory, val storage: QueueItemStorage) : ClientItemQueueGuiDescription(syncId, playerInventory),Runnable {
