...
abstract class SingleCatagory<T : SingleDisplay> : DisplayCategory<T> {
    override fun setupDisplay(display: T, bounds: Rectangle): MutableList<Widget> {
    ...
    override fun getDisplayWidth(display: T): Int {
        return 130
    }
}